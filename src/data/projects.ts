export const projects = [
   ...
   },
   {
      ...
      description: 'An enhanced version of the PotatBotat website.',
   ...
   },
   {
      ...
      description: 'A custom library for creating gradients with optional grain effects.',
   ...
   },
   {
      ...
      description: 'An advanced beat library application for Windows.',
   ...
   },
   {
      ...
      description: 'An innovative platform for developers, functioning like Instagram.',
      ...
      hoverShadowColor: 'hover:shadow-indigo-500/40',
      year: 2024,
   },
   {
      id: 7,
      ...
      imageUrl: 'https://raw.githubusercontent.com/prodbyeagle/eagle-midnight/refs/heads/main/1f985.gif',
      description: 'A custom Discord bot designed for the EGLE server.',
      ...
      tags: ['JavaScript'],
      repoLink: 'https://github.com/prodbyeagle/beatforge',
      hoverShadowColor: 'hover:shadow-bird/70',
      year: 2024,
   },
   {
      id: 8,
      ...
      repoLink: 'https://github.com/prodbyeagle/eglewebsite',
      hoverShadowColor: 'hover:shadow-bird/70',
      year: 2024,
   ...
   },
   {
      ...
      hoverShadowColor: 'hover:shadow-lime-700/40',
      year: "08/2023",
   },
   {
      id: 10,
      ...
      hoverShadowColor: 'hover:shadow-red-700/40',
      year: "05/2023",
   },
];
