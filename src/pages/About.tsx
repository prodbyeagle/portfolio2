      ...
      <div className="min-h-screen bg-neutral-900 text-white px-6 lg:px-12 py-16">
         <div className="max-w-4xl mx-auto">
            ...
            <div className="mt-12 space-y-12">
               <section>
                  <h2 className="text-3xl font-semibold text-neutral-100">Who Am I?</h2>
               ...
               <section className="text-center">
                  ...
                  <div className="flex justify-center space-x-6 mt-6">
                     <a href="https://github.com/prodbyeagle" target="_blank" rel="noopener noreferrer">
                        <GithubLogo className="text-3xl text-neutral-400 hover:text-eagle transition" />
                     </a>
                     <a href="https://twitter.com/prodbyeagle" target="_blank" rel="noopener noreferrer">
                        <TwitterLogo className="text-3xl text-neutral-400 hover:text-eagle transition" />
                     </a>
                     <a href="https://instagram.com/prodbyeagle" target="_blank" rel="noopener noreferrer">
                        <InstagramLogo className="text-3xl text-neutral-400 hover:text-eagle transition" />
                     </a>
                     <a href="https://discord.gg/V33nExqB68" target="_blank" rel="noopener noreferrer">
                        <DiscordLogo className="text-3xl text-neutral-400 hover:text-eagle transition" />
                     </a>
                  </div>
               </section>
            </div>
            ...
            <div className="mt-16 text-center">
               <Link to="/" className="text-eagle hover:underline flex items-center justify-center gap-2">
